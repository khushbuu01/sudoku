...
document.querySelector("#solve").addEventListener('click', () => {
    ...
    //             //     if (su_answer[i][col] === su_answer[i][j] && su_answer[i][col]!=0 && j!=col) 
    //             //         su_answer[i][col] = 0;
    //             // }
    //             // //col
    //             // for (let row = 0; row < CONSTANT.GRID_SIZE; row++) {
    //             //     if (su_answer[row][j] === su_answer[i][j] && su_answer[row][j]!=0 && i!=row) 
    //             //         su_answer[row][j] = 0;
    //             // }
    //             if(su_answer[i][j]!=0){
    //                 //row
    //                 for (let col = 0; col < CONSTANT.GRID_SIZE; col++) {
    //                     if (su_answer[i][col] === su_answer[i][j] && j!=col) 
    //                         su_answer[i][col] = 0;
    //                 }
    //                 //col
    //                 for (let row = 0; row < CONSTANT.GRID_SIZE; row++) {
    //                     if (su_answer[row][j] === su_answer[i][j] && i!=row) 
    //                         su_answer[row][j] = 0;
    //                 }
    //                 // grid
    //                 // var index = [
    ...
    //                 // for(let i=0;i<9;i++){
    //                 //     let rowStart = index[i][0];
    //                 //     let colStart = index[i][1];
    //                 //     for (let row = rowStart; row < rowStart+3; row++) {
    //                 //         for (let col = colStart; col < colStart+3; col++) {
    //                 //             if (su_answer[row][col] === su_answer[i][j] && i!=row && j!=col) 
    //                 //             su_answer[row][col] = 0;
    //                 //         }
    //                 //     }
    //                 // }
